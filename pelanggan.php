            ...
            <div class="card">
              <div class="card-body">
                <table class="table table-striped table-bordered" style="width:100%">
                  <thead>
                    ...
                    <br>
                     ...
                     <tr>
                        ...
                        ?>   
                          <td class="text-center"><?php echo $hasil['nama_pelanggan']; ?></td>
                          <td class="text-center"><?php echo $hasil['nomor_telepon']; ?></td>
                          <td class="text-center">
                            ...
                            <a href="proses_hapus_pelanggan.php?id_pelanggan=<?php echo $hasil['id_pelanggan'];?>" onclick="return confirm('Apakah Anda yakin?');"><button type="button" class="btn btn-danger">Delete <span class="glyphicon glyphicon-trash "></span></button></a>
                          </td>
                      </tr>
                        <?php }?>
                  </tbody>
                  ...
                  <br>
                    <a class="btn btn-primary form-group" style="" href="form_pelanggan.php">Tambah Data Pelanggan</a>
                  <br>
                </form>
              </div>
            </div>
