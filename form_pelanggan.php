    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="./">MENU PELANGGAN</a>
            </div>
            ...
            <div class="animated fadeIn">
                <div class="container-fluid">
                   <div class="col-md-12">
                     <div class="card">
                       <div class="card-body">
                          <form name="form" action="simpan_pelanggan.php" method="post">
                            <div class="form-group">
                            <label for="nama">Nama Pelanggan</label>
                           <input type="text" name="nama_pelanggan"  class="form-control" placeholder="" id="nama_pelanggan">
                             </div>
                            <div class="form-group">
                             <label for="nama">Nomor Telepon</label><p>
                            <input type="number" name="nomor_telepon" class="form-control" placeholder="" id="nomor_telepon"
                             </div>
                            <input type="submit" value="Simpan" class="btn btn-primary">
                            <a href="pelanggan.php"><input type="button" value="Batal" class="btn btn-danger"></a>
                           </form>
                        </div>
                      </div>
                    </div>
