                     ...
                     <tr>
                        ...
                        ?>   
                          ...
                          <td class="text-center">
                            <a href="update.php?id_barang=<?php echo $show['id_barang'];?>"><button type="button" class="btn btn-primary">Edit <span class="glyphicon glyphicon-pencil "></span></button></a>
                                  
                            <a href="hapus_menu.php?id_menu=<?php echo $show['id_menu'];?>"><button type="button" class="btn btn-danger">Delete <span class="glyphicon glyphicon-trash "></span></button></a>
                          </td>
                      </tr>
                        <?php }?>
                  </tbody>
-->
                  ...
                  <br>
                    <a class="btn btn-primary form-group" style="" href="form_pesanan.php">Tambah Data Pesanan </a>
                  <br>
                </form>
              </div>
            </div>
